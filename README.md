...
- [Cherry-pick](#cherry-pick)
    ...
    - [Cherry-picking Conflicts](#cherry-picking-conflicts)
- [Diff Patches](#diff-patches)
    - [Create Diff Patches](#create-diff-patches)
    - [Apply Diff Patches](#apply-diff-patches)
    - [Create Formatted Patches](#create-formatted-patches)
    - [Apply Formatted Patches](#apply-formatted-patches)
- [Rebase](#rebase)
    - [Rebase onto master branch](#rebase-onto-parentmaster-branch)
    - [Rebase Conflicts](#rebase-conflicts)
    - [Rebase onto other branches](#rebase-onto-other-branches)
    - [Undo Rebase](#undo-a-rebase)
    - [Interactive Rebase](#interactive-rebasing)
